...
This project supplies the GNAT source files for the Ada 2022 language-defined units for atomic operations:
...
The sources here are verbatim copies taken from a GNAT native runtime. As such, the implementations are GNAT-specific so their use with other compilers will not work. However, they are not dependent on a specific version of GNAT, unlike regular runtime files.
